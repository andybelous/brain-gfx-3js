...
app.post("/GetSingleEvent", async function (req, res) {
  ...
  getFileFromS3(outputFilePath)
    .then((outputData) => {
      ...
      writeImage(brainRegions, event_id, "principal-max-strain", ENABLE_COLOR)
        .then((data) => {
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, `CSDM-5`, ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, "CSDM-10", ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, "CSDM-15", ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, "CSDM-30", ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, "MPS-95", ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, "MPSR-120", ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, "MPSxSR-28", ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
        ...
        .then((data) => {
          return writeImage(brainRegions, event_id, "MPSxSR-95", ENABLE_COLOR);
        })
        .then((data) => {
          return uploadToS3SingleImage(
            req.body.account_id,
...
function parseSummaryLocations(summary_data, regionsObject) {
  let principal_max_strain = regionsObject.principal_max_strain;
  let principal_min_strain = regionsObject.principal_min_strain;
  let axonal_strain_max = regionsObject.axonal_strain_max;
  let csdm_max = regionsObject.csdm_max;
  let masXsr_15_max = regionsObject.masXsr_15_max;
  let CSDM_5 = regionsObject.CSDM_5;
  let CSDM_10 = regionsObject.CSDM_10;
  let CSDM_15 = regionsObject.CSDM_15;
  let CSDM_30 = regionsObject.CSDM_30;
  let MPS_95 = regionsObject.MPS_95;
  let MPSR_120 = regionsObject.MPSR_120;
  let MPSxSR_28 = regionsObject.MPSxSR_28;
  let MPSxSR_95 = regionsObject.MPSxSR_95;
  let maximum_PSxSR = regionsObject.maximum_PSxSR;
