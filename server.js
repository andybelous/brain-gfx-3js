...
const {
  ...
  uploadToS3SingleLabeledImage,
  getFileFromS3,
  uploadToS3TeamImages,
  getTeamFileFromS3,
    ...
    getFileFromS3(summaryFilePath)
      .then((summaryData) => {
        ...
        writeImage(
          ...
          .then((data) => {
            return writeImage(brainRegions, accountid, "CSDM-5", ENABLE_COLOR);
          })
          .then((data) => {
            return uploadToS3(accountid, "CSDM-5.png", data);
          })
          .then((data) => {
            return writeImage(brainRegions, accountid, "CSDM-10", ENABLE_COLOR);
          })
          .then((data) => {
            return uploadToS3(accountid, "CSDM-10.png", data);
          })
          .then((data) => {
            return writeImage(brainRegions, accountid, "CSDM-15", ENABLE_COLOR);
          })
          .then((data) => {
            return uploadToS3(accountid, "CSDM-15.png", data);
          })
          .then((data) => {
            return writeImage(brainRegions, accountid, "CSDM-30", ENABLE_COLOR);
          })
          .then((data) => {
            return uploadToS3(accountid, "CSDM-30.png", data);
          })
          .then((data) => {
            return writeImage(brainRegions, accountid, "MPS-95", ENABLE_COLOR);
          })
          .then((data) => {
...
function getTeamSummaryimage(team_id, teamSummary) {
  return new Promise(async (resolve, reject) => {
    ...
    const ENABLE_COLOR = true;
    writeImage(brainRegions, accountid, "principal-max-strain", ENABLE_COLOR)
      .then((data) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    getFileFromS3(outputFilePath)
      .then((outputData) => {
        ...
        return getFileFromS3(NextOutputFilePath);
      })
      .then((outputData) => {
        if (!outputData) {
          reject("File does not exists");
        ...
        parseArrayData(summaryData, CSDM_5);
      ...
      .then((outputData) => {
        ...
        parseArrayData(summaryData, CSDM_10);
      ...
      .then((outputData) => {
        ...
        parseArrayData(summaryData, CSDM_15);
      ...
      .then((outputData) => {
        ...
        parseArrayData(summaryData, CSDM_30);
      ...
      .then((outputData) => {
        ...
        parseArrayData(summaryData, MPS_95);
...
app.post("/getTeamSummary", function (req, res) {
  ...
  getStatsSummaryData(team_id)
    .then((team_data) => {
      ...
      getTeamSummaryimage(team_id, newSummary)
        .then((data) => {
          res.send({
            status: 200,
...
app.post("/GetLabeledImage", async function (req, res) {
  ...
  GetLabeledImage1(account_id, event_id)
    .then((data) => {
      res.send({
        status: 200,
      });
...
app.post("/GetSingleEvent", async function (req, res) {
  ...
  GetSingleEventimage(account_id, event_id)
    .then((data) => {
      res.send({
        status: 200,
        message: "Images uploaded successfully.",
